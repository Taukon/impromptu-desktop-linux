...
export const VirtualScreen: React.FC<{
  ...
  return (
    <div className="menu text-base font-medium w-full">
      ...
      <p>
        keyboard layout:{" "}
        <input
          className="input input-sm input-bordered input-primary w-24 max-w-xs text-base"
          ref={layoutRef}
          defaultValue={"jp"}
        />
      </p>
      ...
      <p>
        <input
          className="input input-sm input-bordered input-primary w-full max-w-md text-xl"
          ref={appRef}
          defaultValue={"xterm"}
        />
        <button
